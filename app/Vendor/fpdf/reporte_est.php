...
class PDF extends FPDF
{
    ...
    $this->Cell(70);
    // Título
    $this->Cell(10,8,'Universidad Pedagógica Experimental Libertador',0,0,'C');
	 $this->Ln(4);
	  $this->Cell(70);
	 $this->Cell(10,8,'Centro de Atención San Juan de los Morros',0,0,'C');
    ...
    $this->Ln(20);
		...
		$this->Cell(0,20,"Fecha de Impresión: ".date('d - m - Y')."  ",'',1,'R');
			$this->Ln(2);
	}
	//Pie de página
	function Footer()
	{
		...
		$this->Cell(250,5,'CENTRO DE ATENCIÓN SAN JUAN DE LOS MORROS','',1,'L');
	    //Arial italic 8
	    $this->SetFont('Arial','BI',8);
	    //Número de página
...
{ $db1= mysql_select_db("udbe",$abierto);
	$leer="select * from estudiante where cohorte='$cohorte' and especialidad='$especialidad'";
	$db=mysql_query($leer);


$pdf->SetFont('Arial','B',16);
$pdf->Cell(200,4,'LISTADO DE ESTUDIANTES','',0,'C');
 $pdf->Ln(10);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(15,6,'Código','TRLB',0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(30,6,'Nombre','TRLB',0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(30,6,'Apellido','TRLB',0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(30,6,'Cédula','TRLB',0,'C');
$pdf->SetFont('Arial','B',10);
