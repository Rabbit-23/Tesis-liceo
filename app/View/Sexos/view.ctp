...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Sexo'), array('action' => 'edit', $sexo['Sexo']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Sexo'), array('action' => 'delete', $sexo['Sexo']['id']), array(), __('Are you sure you want to delete # %s?', $sexo['Sexo']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($sexo['Estudiante'] as $estudiante): ?>
		<tr>
