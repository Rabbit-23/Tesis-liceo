...
$pdf->Cell(170,4,'DETALLES DE INSCRIPCION','',0,'C');
 $pdf->Ln(10);
...
$pdf->Cell(40,6,'Nombre','TRLB',0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(40,6,'Apellido','TRLB',0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(30,6,'Cedula','TRLB',0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(15,6,'Curso','TRLB',0,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(30,6,'Periodo','TRLB',0,'C');
...
while($fila2=mysql_fetch_array($db2))
  {
$pdf->Cell(40,5,$fila2['nombre'],'TRLB',0,'C');
$pdf->Cell(40,5,$fila2['apellido'],'TRLB',0,'C');

$pdf->Cell(30,5,$fila2['cedula'],'TRLB',0,'C');
}
$pdf->SetFont('Arial','',10);   
$pdf->Cell(15,5,$fila['Seccion']['nombre_completo'],'TRLB',0,'C');
$pdf->SetFont('Arial','',10);   
$pdf->Cell(30,5,$fila['Periodo']['periodo'],'TRLB',0,'C');
