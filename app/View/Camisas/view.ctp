<div class="camisas view">
<h2><?php echo __('Camisa'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($camisa['Camisa']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Tallacamisa'); ?></dt>
		<dd>
			<?php echo h($camisa['Camisa']['tallacamisa']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Camisa'), array('action' => 'edit', $camisa['Camisa']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Camisa'), array('action' => 'delete', $camisa['Camisa']['id']), array(), __('Are you sure you want to delete # %s?', $camisa['Camisa']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($camisa['Estudiante'])): ?>
	...
	<?php foreach ($camisa['Estudiante'] as $estudiante): ?>
		<tr>
