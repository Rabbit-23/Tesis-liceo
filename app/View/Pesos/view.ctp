<div class="pesos view">
<h2><?php echo __('Peso'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($peso['Peso']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Peso'); ?></dt>
		<dd>
			<?php echo h($peso['Peso']['peso']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Peso'), array('action' => 'edit', $peso['Peso']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Peso'), array('action' => 'delete', $peso['Peso']['id']), array(), __('Are you sure you want to delete # %s?', $peso['Peso']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Pesos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Peso'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php foreach ($peso['Estudiante'] as $estudiante): ?>
		<tr>
