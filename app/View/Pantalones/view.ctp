<div class="pantalones view">
<h2><?php echo __('Pantalon'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($pantalon['Pantalon']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Tallapantalon'); ?></dt>
		<dd>
			<?php echo h($pantalon['Pantalon']['tallapantalon']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Pantalon'), array('action' => 'edit', $pantalon['Pantalon']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Pantalon'), array('action' => 'delete', $pantalon['Pantalon']['id']), array(), __('Are you sure you want to delete # %s?', $pantalon['Pantalon']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($pantalon['Estudiante'])): ?>
	...
	<?php foreach ($pantalon['Estudiante'] as $estudiante): ?>
		<tr>
