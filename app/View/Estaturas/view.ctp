<div class="estaturas view">
<h2><?php echo __('Estatura'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($estatura['Estatura']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Estatura'); ?></dt>
		<dd>
			<?php echo h($estatura['Estatura']['estatura']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Estatura'), array('action' => 'edit', $estatura['Estatura']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Estatura'), array('action' => 'delete', $estatura['Estatura']['id']), array(), __('Are you sure you want to delete # %s?', $estatura['Estatura']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($estatura['Estudiante'])): ?>
	...
	<?php foreach ($estatura['Estudiante'] as $estudiante): ?>
		<tr>
