...
<h2><?php echo __('Zapato'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Tallazapato'); ?></dt>
		<dd>
			<?php echo h($zapato['Zapato']['tallazapato']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Zapato'), array('action' => 'edit', $zapato['Zapato']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Zapato'), array('action' => 'delete', $zapato['Zapato']['id']), array(), __('Are you sure you want to delete # %s?', $zapato['Zapato']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Zapatos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Zapato'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($zapato['Estudiante'])): ?>
	...
	<?php foreach ($zapato['Estudiante'] as $estudiante): ?>
		<tr>
